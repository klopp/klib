...
static void _transform( SHA256 *sha256, const unsigned char *message,
...
void sha256_update( SHA256 *sha256, const unsigned char *message,
    ...
    _transform( sha256, sha256->m_block, 1 );
    _transform( sha256, shifted_message, block_nb );
...
unsigned char *sha256_finalize( SHA256 *sha256, unsigned char *digest ) {
    ...
    if( digest ) {
        ...
        _transform( sha256, sha256->m_block, block_nb );
        for( i = 0; i < 8; i++ ) {
